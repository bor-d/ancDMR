...
#list_dir = sys.argv[1]
#ref file is generated by perl script cgpositionFinder.pl and has a name like ref/chr*.CpG.positions.txt
#ref_file = sys.argv[2]
ref_file = "~/Documents/Bioinf/Hunters-Gatherers/Diffmeth/test_chr1/chr1.CpG.positions.txt"
